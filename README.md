...
```
서연 승차 → 하늘 승차      4.1km    3,491원 ÷ 1명   ← 서연 혼자
나 승차   → 하늘 하차      7.8km    6,747원 ÷ 3명   ← 셋이 함께
하늘 하차 → 서연 하차      3.8km    3,262원 ÷ 2명   ← 하늘이 내린 뒤
기본요금                            4,800원 ÷ 3명

→ 서연 8,900원 · 하늘 3,900원 · 나 5,500원 = 18,300원 (택시 총요금과 일치)
```

혼자 탔다면 14,000원이었을 사람이 **5,500원, 61% 절약**합니다.
...
- **본인 인증 없음** — 해커톤인 만큼 본인인증 기능은 아직 구현하지 않았습니다
